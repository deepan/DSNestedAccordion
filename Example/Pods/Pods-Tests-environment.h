...
// DSNestedAccordion
#define COCOAPODS_POD_AVAILABLE_DSNestedAccordion
#define COCOAPODS_VERSION_MAJOR_DSNestedAccordion 0
#define COCOAPODS_VERSION_MINOR_DSNestedAccordion 1
#define COCOAPODS_VERSION_PATCH_DSNestedAccordion 0
